...
export default function SearchSection() {
    ...
    // *************************************************************
    useEffect(() => {
        console.log("Redux search updated:", reduxSearch);
    }, [reduxSearch]);

    // Keep local input in sync with Redux (handles persistor rehydrate and external updates)
    useEffect(() => {
        if (reduxSearch !== undefined && reduxSearch !== null && reduxSearch !== search) {
            setsearch(reduxSearch);
        }
    }, [reduxSearch, search]);
                        ...
                        <div className="search_box_input">
                            <form
                                ...
                                onSubmit={(e) => {
                                    ...
                                    console.log("Dispatching searching:", trimmed);
                                    if (trimmed.length === 0) return;
                                    dispatch(searching(trimmed));
