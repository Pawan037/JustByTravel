                ...
                <div id="sidebar_filter_hotel" className="row gy-md-5 gy-4">
                            ...
                            <div className="hotel-img-wrap">
                                ...
                                >
                                    <img
                                        ...
                                        width="1320"
                                        height="770"
                                        src="https://gofly-wp.egenstheme.com/wp-content/uploads/2025/09/Image-52-4.webp"
                                        className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                                        alt=""
                                        decoding="async"
                                        srcset="https://gofly-wp.egenstheme.com/wp-content/uploads/2025/09/Image-52-4.webp 1320w, https://gofly-wp.egenstheme.com/wp-content/uploads/2025/09/Image-52-4-300x175.webp 300w, https://gofly-wp.egenstheme.com/wp-content/uploads/2025/09/Image-52-4-600x350.webp 600w, https://gofly-wp.egenstheme.com/wp-content/uploads/2025/09/Image-52-4-1024x597.webp 1024w, https://gofly-wp.egenstheme.com/wp-content/uploads/2025/09/Image-52-4-768x448.webp 768w"
                            ...
                            <div className="hotel-content">
                                <div className="rating-area">
                                    <div className="rating-text">
                                        ...
                                        <span className="total">0 reviews</span>
                                    </div>
                                </div>
                                <h5>
                                ...
                                <div className="location-area">
                                    <div className="location">
                                        ...
                                        <a href="https://gofly-wp.egenstheme.com/hotel-location/bangladesh/">
                                            Bangladesh
                                        </a>{" "}
                                        <i className="bi bi-arrow-right"></i>{" "}
                                        <a href="https://gofly-wp.egenstheme.com/hotel-location/dhaka/">
                                            Dhaka
                                        </a>{" "}
                                    </div>
                                    <a
                    ...
                    {/* <div className="package-grid-page">
                        <div className="package-grid-top-area">
                            <span>
                                Showing <strong>1</strong> of <strong>12</strong> results
                            </span>
                                ...
                                <div className="selector-area">
                                    <div className="nice-select">
                                        ...
                                        <ul className="list">
                                            ...
                                            <li data-value="hotels" className="option">Hotels</li>
                                            <li data-value="flights" className="option">Flights</li>
                                        </ul>
                                    </div>
                                </div>
