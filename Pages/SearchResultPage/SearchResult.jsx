                        ...
                        {/* <div className="hotel-grid-top-area">
                            ...
                            <div className="selector-and-list-grid-area">
                                ...
                                <div className="selector-area">
                                    ...
                                    </select><div className="nice-select" tabIndex="0"><span className="current">Default</span><ul className="list"><li data-value="default" className="option selected focus">Default</li><li data-value="latest" className="option">Latest</li><li data-value="price_high" className="option">Price High</li><li data-value="price_low" className="option">Price Low</li></ul></div>
                                </div>
